...
def tickle_and_iv(
        ...
        wait_time, bath_temp, start_time, current_mode, make_bgmap,
):
...
def tes_yield(S, target_bg, out_fn, start_time):
    ...
    for bl in target_bg:
        ...
        h = ax_rn.hist(Rn, range=(0.005,0.012), bins=50, histtype= u'step',linewidth=2,color = 'k')
...
if __name__ == "__main__":
    ...
    run(S, cfg, target_bg=bgs, bias_high=args.bias_high, bias_low=args.bias_low,
        bias_step=args.bias_step, wait_time=args.wait_time, bath_temp=args.temp,
        current_mode=args.current_mode, make_bgmap=args.make_bgmap,
