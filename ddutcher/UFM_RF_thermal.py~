...
fav_tune_files = '/data/smurf_data/tune/1662662390_tune.npy'
...
out_fn = '/data/smurf_data/UFM_testing/Mv24_ph004/RF_thermal_3.csv'
...
for target_band in bands:
    ...
    bias_array = np.array([4.8, 4.8, 8.4, 8.2, 4.7, 4.8, 8.2, 8.1, 2.,  2.4, 7.2, 7.2])
    ...
    for new_band in bands:
        ...
        fieldnames = ['time','bias_voltage', 'band', 'off_band', 'off_band_tone','off_band_att_uc','data_path'] 
        row = {}
        row['time'] = dat_path[-14:-4] 
        row['bias_voltage'] = '4.8_4.8_8.4_8.2_4.7_4.8_8.2_8.1_2_2.4_7.2_7.2'
        ...
        try:
            ...
            save_name = f'{start_time}_band3_channel167.png'
